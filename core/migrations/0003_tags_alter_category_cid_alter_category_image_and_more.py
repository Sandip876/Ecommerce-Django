...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('core', '0002_alter_category_options_category_image_category_title_and_more'),
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='category',
            name='cid',
            field=shortuuid.django_fields.ShortUUIDField(alphabet=None, length=22, max_length=22, prefix='', unique=True),
        ),
        migrations.AlterField(
            model_name='category',
            name='image',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sku', shortuuid.django_fields.ShortUUIDField(alphabet=None, length=22, max_length=22, prefix='', unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('vid', shortuuid.django_fields.ShortUUIDField(alphabet=None, length=22, max_length=22, prefix='', unique=True)),
